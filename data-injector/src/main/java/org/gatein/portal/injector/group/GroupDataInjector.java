...
public class GroupDataInjector extends AbstractInjector {
     ...
     *
     * @param groupName    The default groupName
     * @param parentName   The parent group name
     * @param startIndex   The startIndex and the endIndex are used to generate a number of group, such as groupName_0, groupName_1, groupName_n
     * @param endIndex     The end of index
     * @param createParent Boolean parameter that allow to create parent if doesn't exist
     */
    @Managed
    ...
    public void createGroups(@ManagedDescription("Group name") @ManagedName("groupName") String groupName
        ...
        try {
            ...
            startTransaction("create new groups");
            ...
            endTransaction("create new groups");
        }
    }
     ...
     *
     * @param groupName    The default group name
     * @param parentName   The parent group name
     * @param startIndex   The startIndex and the endIndex are used to generate a number of group that need to remove,
     *                     such as groupName_0, groupName_1, groupName_n
     * @param endIndex     The end of index
     * @param deleteParent Boolean parameter that allow to remove parent.
     */
    @Managed
    ...
    public void removeGroups(@ManagedDescription("Group name") @ManagedName("groupName") String groupName
        ...
        try {
            ...
            int sIndex = Integer.parseInt(startIndex);
            int eIndex = Integer.parseInt(endIndex);
            startTransaction("remove groups");
            for (int i = sIndex; i <= eIndex; i++) {
     ...
     * @param groupName      The group that user in. Format of groupName: [/parentName]/groupName such as: /platform/guest
     * @param membershipName The membership type, such as: member, validator, ...
     * @param startIndex     The startIndex and the endIndex are used to generate a number of user that need to added to membership,
     *                       such as groupName_0, groupName_1, groupName_n
     * @param endIndex       The end of index
     */
    @Managed
    ...
    public void addMemberships(@ManagedDescription("User name") @ManagedName("userName") String userName
        ...
        try {
            ...
            int sIndex = Integer.parseInt(startIndex);
            int eIndex = Integer.parseInt(endIndex);
            startTransaction("add memberships");
            for (int i = sIndex; i <= eIndex; i++) {
            ...
            endTransaction("add memberships");
        }
    }
     ...
     * @param groupName      The group that user in. Format of groupName: [/parentName]/groupName such as: /platform/guest
     * @param membershipName The membership type, such as: member, validator, ...
     * @param startIndex     The startIndex and the endIndex are used to generate a number of user that need to removed from membership,
     *                       such as groupName_0, groupName_1, groupName_n
     * @param endIndex       The end of index
     */
    @Managed

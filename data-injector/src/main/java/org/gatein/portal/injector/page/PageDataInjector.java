...
public class PageDataInjector extends AbstractInjector {
     ...
     *
     * @param type            The type of site (ex: portal, group, user)
     * @param name            The name of site
     * @param pageNamePrefix  The prefix name for page
     * @param pageTitlePrefix The prefix title for page
     * @param startIndex      The start of index to identify page
    ...
    public void createPages(
        ...
        try {
            startTransaction("create new pages");
            ...
            endTransaction("create new pages");
        }
    }
